        ...
        <div class="col-sm-8 blog-main">
            ...
            <div class="blog-post" style="background: #f5f5f5;">
                ...
                <div class="content">
                    <div class="list">
                        <center>
                            <form action="/findPlane" method="post" style="margin: 0px;">
                                航班号：
                                <input type="text" placeholder="${planeName}" name="planeName" class="btb" style="font-family: sans-serif;">
            ...
            <div class="blog-post showBus">
                    ...
                    <p style="font-family: '微软雅黑';">
                        <i class="fa fa-plane"></i> ${planeRte.routeName}
                    </p>
                    <p style="font-family: '微软雅黑';">
                        出发-到达时间：${planeDel.planeBeginTime}（计划起飞）-${planeDel.planeEndTime}（计划到达）
                    </p>
