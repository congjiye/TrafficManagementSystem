...
<div class="container">
    <div class="blog-header">
        ...
        <p class="lead blog-description">支持站站查询、线路和条件查询</p>
    </div>
    <div class="row">
        ...
        <div class="col-sm-8 blog-main">
                    ...
                    <div class="list">
                        <center>
                            <form action="/desTrainStation" method="post" style="margin: 0px;">
                                搜索站点：
                                <input type="text" value="${trainStation}" name="trainStationName" class="btb" style="font-family: sans-serif;">
            ...
            <c:forEach items="${trainRouteStation}" var="train">
                <div class="blog-post showBus">
                    <h2>${train}</h2>
                    <hr>
                    <p style="font-family: '微软雅黑';">
                        <i class="fa fa-train"></i> ${train}站
                    </p>
                    <a href="/chooseTrain?end=${train}" style="float: right;transform: translate(-5px,-20px);font-size: 16px;margin-left: 10px;">« 设为目的地</a><a href="/chooseTrain?start=${train}" style="float: right;transform: translate(-5px,-20px);font-size: 16px;">» 设为始发站</a>
                </div>
            </c:forEach><!-- /.blog-post -->
            <div class="blog-post">
                ...
                <blockquote>
                    ...
                    <p>
                        热门火车：<a href="/desTrainRoute?trainName=D906" style="font-family: sans-serif;">D906</a>
                    </p>
                </blockquote>
