    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" data-id="11" data-title="基本资料" data-url="/userDetail?user=<%=session.getAttribute("username")%>"
                           class="site-demo-active" data-type="tabAdd">基本资料</a></dd>
                    <dd><a href="javascript:;" data-id="12" data-title="安全设置" data-url="/userSafeInfo?user=<%=session.getAttribute("username")%>"
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="fa fa-user" style="margin-right: 10px;"></i>用户信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-id="9" data-title="权限管理" data-url="/userAuthority"
                               class="site-demo-active" data-type="tabAdd">权限管理</a></dd>
                        <dd><a href="javascript:;" data-id="10" data-title="信息管理" data-url="/userInfo"
                               class="site-demo-active" data-type="tabAdd">信息管理</a></dd>
                        <%--<dd><a href="">超链接</a></dd>--%>
                    </dl>
                </li>
