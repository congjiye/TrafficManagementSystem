...
<div class="container">
    <div class="blog-header">
        ...
        <p class="lead blog-description">支持站站查询、线路查询、站点查询</p>
    </div>
    <div class="row">
        ...
        <div class="col-sm-8 blog-main">
                    ...
                    <div class="list">
                        <center>
                            <form action="/desTrain" method="post" style="margin: 0px;">
                                <input type="text" placeholder="出发站" name="start" id="start" class="btb" value="${start}">
                                <i class="fa fa-arrows-h" aria-hidden="true" id="exchange" style="cursor: pointer;"></i>
                                <input type="text" placeholder="目的地" name="end" id="end" class="btb" value="${end}">
            ...
            <div class="blog-post">
                ...
                <p style="font-family: 微软雅黑;">
                    为了方便用户日常体验，火车查询功能共设有三种查询方式，分别为站站查询、线路查询和站点查询。
                    其中站站查询查询的是始发地到目的地的可选列车，例如“杭州东-上海虹桥 将显示可乘火车”等。
                    线路查询是根据车次号查询线路，站点查询查询经过此站的列车车次，因此用户输入时需按照以下要求输入。
                </p>
                <ul>
                    <li>出发地、目的地请按实际站点名输入，请勿输入不存在的站点</li>
                    <li>线路查询目前不支持模糊查询，请完整输入线路名称</li>
                    <li>站点查询支持模糊查询，为您造成不便深表歉意</li>
                </ul>
            </div><!-- /.blog-post -->
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
            ...
            <div class="sidebar-module">
                ...
                <ol class="list-unstyled">
                    <li><a href="/chooseBus">公交</a></li>
                    <li><a href="/chooseSubway">地铁</a></li>
                    <li><a href="/chooswTrain">火车</a></li>
                    <li><a href="/chooswPlane">飞机</a></li>
                    <li><a href="/getMap">地图</a></li>
                </ol>
            </div>
        </div><!-- /.blog-sidebar -->
