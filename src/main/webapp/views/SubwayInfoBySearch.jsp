...
<div class="container">
    <div class="blog-header">
        ...
        <p class="lead blog-description">地铁详细信息显示</p>
    </div>
    <div class="row">
        ...
        <div class="col-sm-8 blog-main">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <p>
                        <small>运行时间：${detail.subwayEndTime}-${detail.subwayEndTime}</small>
                    </p>
                    <p>
                        [地铁信息介绍]
                    </p>
            ...
            <h4><strong>${subway.subwayName}路线站点</strong>
            </h4>
            <hr style="background-color:#00cec9;height:2px;border:none">
            <div id="go">
                <c:forEach items="${station}" var="stationlist">
                    <div style="float: left;" class="divType"  id="${stationlist.stationId - station.get(0).stationId + 1}">
                        <a href="/desSubwayStation?stationName=${stationlist.stationName}" class="aType"><i class="iType">${stationlist.stationId - station.get(0).stationId + 1}</i>${stationlist.stationName}</a>
                    </div>
                </c:forEach>
            </div>
        </div><!-- /.blog-main -->
