        ...
        <div class="col-sm-8 blog-main">
                    ...
                    <div class="list">
                        <center>
                            <form action="/desTrainRoute" method="post" style="margin: 0px;">
                                车次号：
                                <input type="text" value="${train.trainName}" name="trainName" class="btb" style="font-family: sans-serif;">
            ...
            <div class="blog-post showBus">
                ...
                <p style="font-family: '微软雅黑';">
                    <i class="fa fa-train"></i> ${trainRoute.routeName}
                </p>
                <p style="font-family: '微软雅黑';">
                    出发-到达时间：${trainDel.trainBeginTime}-${trainDel.trainEndTime}
                </p>

                <a href="https://flights.ctrip.com/actualtime/fno--${planeName}.html" style="float: right;transform: translate(-5px,-20px);font-size: 16px">» 查看详情</a>
            </div><!-- /.blog-post -->
            <div class="blog-post">
