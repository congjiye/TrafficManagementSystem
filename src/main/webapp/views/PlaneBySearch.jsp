...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 blog-main">
            ...
            <c:forEach items="${plane}" var="planelist">
                <div class="blog-post showBus">
                    <h2><span onclick="window.location.href='/findPlane?planeName=${planelist.planeName}'" style="cursor: pointer;">${planelist.planeName}</span><small style="float: right;line-height: 33px;"> <i class="fa fa-plane"></i> ${planelist.routeName}</small> </h2>
                    <hr style="margin-top: 0px;">
                    <p style="font-family: '微软雅黑';">
                        出发-到达时间：${planelist.planeBeginTime}-${planelist.planeEndTime}
                    </p>

                    <a href="https://flights.ctrip.com/itinerary/oneway/${planeExc}" style="float: right;transform: translate(-5px,-20px);font-size: 16px">» 立即购票</a>
                </div><!-- /.blog-post -->
            </c:forEach>
