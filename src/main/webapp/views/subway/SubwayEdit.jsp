...
<fieldset class="layui-elem-field layui-field-title">
    <legend>修改${subway.subwayName}信息</legend>
</fieldset>
<div style="margin: 20px;">
    <form class="layui-form" action="/editSubway" method="post">
        <div class="layui-form-item">
            <label class="layui-form-label">地铁名</label>
            <div class="layui-input-block">
                <input type="text" name="subwayName" lay-verify="required" value="${subway.subwayName}" autocomplete="off" class="layui-input layui-disabled" readonly="readonly">
            </div>
        </div>
        <div class="layui-form-item">
