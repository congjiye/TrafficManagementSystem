        ...
        <div class="col-sm-8 blog-main">
            ...
            <c:forEach items="${bus}" var="buslist">
                <div class="blog-post showBus">
                    <h2>${buslist.bus_name} <small>路公交</small></h2>
                    <hr style="margin-top: 0px;">
                    <p style="font-family: '微软雅黑';">
                        始发站-终点站: <small style="color: #9b9b9b;">${buslist.route_name}</small>
                    </p>

                    <a href="/desRoute?busName=${buslist.bus_name}" style="float: right;transform: translate(-5px,-20px);font-size: 16px">» 查看更多</a>
                </div><!-- /.blog-post -->
            </c:forEach>
